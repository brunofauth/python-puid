...
def check_predefined(chars: Charsets, shifts) -> None:
    n_chars = len(Charset.predefined(kind=chars))
    assert bit_shifts(n_chars) == shifts


def test_bit_shifts_pow_2():
    assert bit_shifts(len(Charset.custom(characters='dingosky'))) == [(7, 3)]
...
def test_bit_shifts_non_pow_2():
    ...
    check_predefined(Charsets.ALPHANUM_LOWER, [(35, 6), (39, 4), (47, 3), (63, 2)])
    check_predefined(Charsets.SAFE_ASCII, [(89, 7), (91, 6), (95, 5), (127, 2)])
