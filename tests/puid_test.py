...
def test_3bit_custom(util):
    ...
    dingosky_id = Puid(bitwidth=24, charset="dingosky", entropy_source=dingosky_bytes)
...
def test_hex_with_carry(util):
    ...
    hex_id = Puid(bitwidth=12, charset=Charsets.HEX_UPPER, entropy_source=hex_bytes)
...
def test_3bit_with_carry(util):
    ...
    dingosky_bytes = util.fixed_bytes("c7 c9 00 2a bd 72")
    dingosky_id = Puid(bitwidth=9, charset="dingosky", entropy_source=dingosky_bytes)
...
def test_3bit_unicode_with_carry(util):
    dingosky_bytes = util.fixed_bytes("c7 c9 00 2a bd 72")
    dingosky_id = Puid(bitwidth=9, charset="dîngøsky", entropy_source=dingosky_bytes)
...
def test_5bit_with_carry(util):
    ...
    safe32_id = Puid(bitwidth=20, charset=Charsets.SAFE32, entropy_source=safe32_bytes)
...
def test_6_plus_bit(util):
    ...
    alphanum_id = Puid(bitwidth=17, charset=Charsets.ALPHANUM, entropy_source=alphanum_bytes)
...
def test_alpha_10_lower(util):
    ...
    alpha_10_lower_id = Puid(bitwidth=14, charset="abcdefghij", entropy_source=alpha_10_lower_bytes)
...
def test_base16(util):
    ...
    base16_id = Puid(bitwidth=12, charset=Charsets.BASE16, entropy_source=base16_bytes)
...
def test_base32(util):
    ...
    base32_id = Puid(bitwidth=25, charset=Charsets.BASE32, entropy_source=base32_bytes)
...
def test_base32_hex(util):
    ...
    base32_hex_id = Puid(bitwidth=30, charset=Charsets.BASE32_HEX, entropy_source=base32_hex_bytes)
...
def test_wordSafe32(util):
    ...
    wordSafe32_id = Puid(bitwidth=20, charset=Charsets.WORD_SAFE32, entropy_source=wordSafe32_bytes)
...
def test_unicode_chars(util):
    ...
    unicode_id = Puid(bitwidth=24, charset='dîngøsky:￦', entropy_source=unicode_bytes)
